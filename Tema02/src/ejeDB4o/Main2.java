...
/*
 * Main2, mejorando el código de Main
 */
public class Main2 {
	...
	public static void main(String[] args) {
		...
		Persona p4=new Persona("Luis","Guadalajara");
		...
		System.out.println("Ahora todas aquellas que viven en 'Guadalajara'");
		verPersonasPorCiudad(db,"Guadalajara",0,0);
		System.out.println("Y finalmente todas aquellas que viven en 'Guadalajara' y se llaman 'Juan'");
		verPersonasPorNombreYCiudad(db,"Juan","Guadalajara",0,0);	
	...
	public static void verPersonas(ObjectContainer db,String nombre, String ciudad,long inicio,long cuantas) {
		// Visualiza todas las tuplas mediante Query By Example
		Persona persEjemplo= new Persona(nombre,ciudad);
	...
	public static void verPersonas(ObjectContainer db,long inicio,long cuantas) {
		// Visualiza todas las tuplas mediante Query By Example
		verPersonas(db,null,null,inicio,cuantas);
	}
	
	public static void verPersonasPorNombre(ObjectContainer db,String nombre,long inicio,long cuantas) {
		// Visualiza las personas con cierto nombre mediante Query By Example
		verPersonas(db,nombre,null,inicio,cuantas);
	}
	
	public static void verPersonasPorCiudad(ObjectContainer db,String ciudad,long inicio,long cuantas) {
		// Visualiza las personas con cierto nombre mediante Query By Example
				verPersonas(db,null,ciudad,inicio,cuantas);
	}
	
	public static void verPersonasPorNombreYCiudad(ObjectContainer db,String nombre, String ciudad,long inicio,long cuantas) {
		// Visualiza las personas con cierto nombre mediante Query By Example
				verPersonas(db,nombre,ciudad,inicio,cuantas);
	}
